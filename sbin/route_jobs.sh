...
# Default-Stop:      0 1 6
# Short-Description: Route jobs messages from a source to a destination
# Description:       Route jobs messages from a {file, directory, amqp} to a {directory, api}
### END INIT INFO

####### Customizations START #######
APP_NAME=route_jobs
APP_BASE=/soft/warehouse-apps-1.0/Manage-Jobs
